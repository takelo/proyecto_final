<footer class="site-footer">
  <div class="container clearfix">
    <div class="footer-informacion">
      ...
      <div id="contacto" class="contacto">
        <h3>Contactanos</h3>
        <form method="post" action="https://formspree.io/noresteideas@gmail.com">
          ...
          <div class="field half first">
            <input type="text" name="comercio" id="comercio" placeholder="Comercio" />
          </div>
          <div class="field half">
  ...
  <p class="copyright"><!-- Inserta esta etiqueta en la sección "head" o justo antes de la etiqueta "body" de cierre. -->
      Noreste Fabricando Ideas ©2019 - Todos los derechos reservados. Sitio desarrollado por <a  href='https://takelo.github.io/jme/' >Echeverria Juan Manuel</a>
  </p>
</footer>
